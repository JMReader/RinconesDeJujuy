...
export class HeaderComponent implements OnInit {
  ...
  URL:string = window.location.protocol + "/koritacrah.github.io/RinconesDeJujuy/check-in/0";
  ...
  check_hotel(){
    this.status=1; 
    this.router.navigate(['koritacrah.github.io/RinconesDeJujuy/', this.status]);
